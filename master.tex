...
% ------------------------------------------------------------------------------
 ...
 \section{Automorfizmi}
  ...
  $stab(v) = \{i \mid v^{g_i} = v\}$. Grupa automorfizama generisana skupom
  $\{g_i \mid i \in \bigcap_{1 \leq j \leq k} stab(v_j)\}$ je podgrupa
  stabilizatora niza $\nu = (v_1, \dots, v_k)$.

  Definišimo $mcr(v) = \min \Omega_v^{<g_1, \dots, g_n>}$. Kako je prema
  prethodno pokazanom $P_C$ moguće primenjivati za bilo koja dva čvora iz iste
  orbite, možemo odseći pretragu u bilo kom čvoru za koji važi $v \neq mcr(v)$.
