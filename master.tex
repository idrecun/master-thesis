  ...
  \end{definition}
   ...
   \begin{figure}[htp]
	   ...
	   \begin{tikzpicture}
		   ...
		   \end{scope}
	   \end{tikzpicture}
	   \caption{Levo bojenje je ekvitabilno zato što je svaki zeleni čvor
	   povezan sa tačno dva crna, a svaki crni čvor sa tačno jednim zelenim i
	   tačno jednim crnim. Desno bojenje nije ekvitabilno zato što postoje
	   zeleni čvorovi sa različitim brojem zelenih suseda.}
	   \label{img:equitable}
   \end{figure}
  ...
  \end{proof}
   ...
   \begin{figure}[htp]
	   ...
	   \begin{tikzpicture}
		   ...
		   \end{scope}
	   \end{tikzpicture}
	   \caption{Najgrublje ekvitabilno bojenje levog grafa razdvaja čvorove
	   grafa tačno po orbitama u grupi automorfizama grafa. To naravno nije
	   uvek slučaj, što se može videti iz primera desnog grafa čije je
	   najgrublje ekvitabilno bojenje jednobojno.}
	   \label{img:equitable}
   \end{figure}
  ...
  \begin{proof}
	  ...
	  \begin{itemize}
		  ...
		  \item[] \textbf{Induktivni korak} Neka je $\xi \leq \sim_{\pi_j}$ za sve $ j \leq i$.
			  ...
			  particije $\xi$. Tada je $\psi(G, x, W) = \psi(G, y, W)$, pa oni ne
	  ...
	  \gamma(x) = \gamma(y) \implies \psi(G, x, C) = \psi(G, y, C)\}$. Jasno je da je
		  ...
		  \item[] \textbf{Induktivni korak} Neka je $C \in \mathcal{B}$ i $C = C_1 \sqcup \dots \sqcup C_k$.
			  \begin{itemize}
				  ...
				  \item[2\degree] Ako je $C \not \in \mathcal{A}$, onda su $C_1,
					  ...
					  \mathcal{B}$. Tada je $\psi(G, x, C_s) = \psi(G, x, C) -
  ...
  \end{definition}
   ...
   \begin{figure}[htp]
	   ...
	   \begin{tikzpicture}
		   ...
		   \end{scope}
	   \end{tikzpicture}
	   \caption{Graf sa ekvitabilnim bojenjem (levo) i odgovarajući količnički
	   graf (desno).}
	   \label{img:quotient}
   \end{figure}
