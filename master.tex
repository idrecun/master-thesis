...
\apstr{%
	U ovom radu opisan je i realizovan algoritam za rešavanje problema
	izomorfizma grafova \textbf{GI}. Dat je formalan opis opšteg okvira za
	konstrukciju algoritma za rešavanje \textbf{GI} prikazan u radu
	\cite{McKay}.  Konstruisan je algoritam zasnovan na proceduri profinjavanja
	bojenja grafa i uvedeno je jedno uopštenje te procedure. Algoritam je
	implementiran u programskom jeziku \CC\ u okviru programa \emph{morphi} čije
	je vreme izvršavanja testirano na raznovrsnom skupu grafova i napravljeno
	je poređenje rezultata sa rezultatima nekih najuspešnijih rešavača za
	problem izomorfizma grafova.
}

% Ključne reči na srpskom jeziku (u odabranom pismu)
\kljucnereci{izomorfizam grafova, kanonska forma grafa, grupa automorfizama, obojen graf, profinjavanje bojenja}
